...
void ConnectWifi() {
  ...
  while (WiFi.status() != WL_CONNECTED) {
    ...
    display("Menyambungkan", 1, 1, false, true, false);
    for (int i = 0; i < 3; i++) {
...
void scaling() {
  ...
  if (scale.is_ready()) {
    ...
    display("Teu Kadetek", 2, 1, false, true, false);
...
void loop() {
  ...
  display("Sakedap di cek", 1, 0, true, false, false);
  display("heula", 4, 1, false, true, false);
  for (int i = 0; i < 3; i++) {
  ...
  switch (x) {
  case 1:
    display("Data Sukses", 1, 0, true, false, false);
    display("Kasimpen", 2, 1, false, true, false);
    for (int i = 0; i < 3; i++) {
      display(".", 2, 1, false, true, false);
      delay(500);
    }
  ...
  default: //Error Unknown
    ...
    display("Hatur Nuhun",1,0,true,false,true);
    delay(1500);
